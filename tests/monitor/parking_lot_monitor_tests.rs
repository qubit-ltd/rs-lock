...
#[test]
fn test_parking_lot_monitor_timed_wait_propagates_completion_error() {
...
#[test]
fn test_parking_lot_monitor_notify_one_wakes_exactly_one_waiter() {
...
#[test]
fn test_parking_lot_monitor_guard_wait_for_returns_woken_when_notified() {
    let monitor = Arc::new(ParkingLotMonitor::new(false));
...
fn test_parking_lot_monitor_timed_predicate_wait_propagates_timer_error() {
    let monitor =
        ParkingLotMonitor::with_timer(false, Arc::new(FailingTimer::new()));
